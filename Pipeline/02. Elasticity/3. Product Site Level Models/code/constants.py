...
FINAL_SUMMARY_COLS = [
    ...
    f"PRED_{UNIT}", APE, PRICE, Cluster_Granularity,
...
FINAL_OUTPUT_COLS = [
    ...
    Cluster_Granularity, Product_Code_var, DESC_COL_PRODUCT,  RANK, SERVICE_VAR,
    "Weighted elasticity", "Weighted  rsq", "Weighted PValue", "Check", "Significant ?"]
